    ...
    while True:
        ...
        for i, chunk in enumerate(chunks):
            ...
            if level == 0:
                ...
                user_content = f"""Summarize this meeting transcript section (part {i+1} of {len(chunks)}). 
...
"""
                ...
                system_message = "You are an expert at summarizing summaries of meeting transcripts. Create a concise overview that preserves the most important information from multiple summaries."
                user_content = f"""Create a consolidated summary from this summary section (part {i+1} of {len(chunks)}).
